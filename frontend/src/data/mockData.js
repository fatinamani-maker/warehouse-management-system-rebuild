...
// ===== USERS & ROLES =====
export const roles = [
    { id: "warehousemanager", name: "Warehouse Manager", description: "Full inbound workflow authority" },
    { id: "storekeeper", name: "Store Keeper", description: "Operational warehouse execution" },
...
export const rolePermissions = {
    warehousemanager: permissions,
    storekeeper: permissions.filter(p => p.includes("view") || p.includes("execute") || p.includes("scan") || p.startsWith("inbound")),
    auditor: permissions.filter(p => p.includes("view")),
    readonly: permissions.filter(p => p.includes("view")),
};
export const users = [
    { id: "USR000001", name: "John Admin", email: "john@acme.com", role: "warehousemanager", tenants: ["TNT000001", "TNT000002"], warehouses: ["WH000001", "WH000002"], status: "active", lastLogin: "2026-02-09T08:30:00Z" },
    { id: "USR000002", name: "Sarah Manager", email: "sarah@acme.com", role: "storekeeper", tenants: ["TNT000001"], warehouses: ["WH000001"], status: "active", lastLogin: "2026-02-09T09:15:00Z" },
    { id: "USR000003", name: "Mike Clerk", email: "mike@acme.com", role: "storekeeper", tenants: ["TNT000001"], warehouses: ["WH000001"], status: "active", lastLogin: "2026-02-08T14:00:00Z" },
    ...
    { id: "USR000005", name: "Tom HQ", email: "tom@acme.com", role: "readonly", tenants: ["TNT000001"], warehouses: ["WH000001", "WH000002"], status: "inactive", lastLogin: "2026-01-20T16:00:00Z" },
];
// ===== LOCATIONS =====
export const zones = [
...
export const simulateScanCodes = [
    { label: "SKU000001 (Bearing) — QR", value: "QR:SKU000001:LOT2026A", mode: "qr" },
    { label: "SKU000002 (Pump) — QR", value: "QR:SKU000002:SN-HP200-0042", mode: "qr" },
    { label: "SKU000003 (Battery) — RFID", value: "EPC:300833B2DDD9014000000003", mode: "rfid" },
    { label: "SKU000005 (Gloves, Quarantine) — RFID", value: "EPC:300833B2DDD9014000000005", mode: "rfid" },
    { label: "Unknown Tag", value: "EPC:UNKNOWN000000000000", mode: "rfid" },
    { label: "GRN000143 — QR", value: "QR:GRN000143", mode: "qr" },
];
// ===== LOV (List of Values) =====
