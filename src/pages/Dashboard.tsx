...
const kpiCards = [
  { label: "Today's Inbound", value: dashboardKPIs.todayInbound, icon: ArrowDownToLine, color: "text-blue-600" },
  { label: "Pending Putaway", value: dashboardKPIs.pendingPutaway, icon: PackageOpen, color: "text-amber-600" },
  { label: "Stock Accuracy", value: `${dashboardKPIs.stockAccuracy}%`, icon: Target, color: "text-emerald-600" },
  { label: "Open Picks", value: dashboardKPIs.openPicks, icon: ClipboardList, color: "text-violet-600" },
  { label: "Overdue Shipments", value: dashboardKPIs.overdueShipments, icon: Truck, color: "text-red-600" },
  { label: "Exceptions", value: dashboardKPIs.exceptionsCount, icon: AlertTriangle, color: "text-orange-600" },
];
